          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {isEditing && (
              <button
                ...
                disabled={isDeleting}
                title="Delete Notice"
                className="absolute top-2 right-12 sm:top-5 sm:right-16 text-red-400 hover:text-red-300 cursor-pointer active:scale-95 hover:scale-110 z-10 p-2.5 rounded-full hover:bg-red-500/10 transition-all duration-300"
              >
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4 pt-6 sm:pt-8 border-t border-gray-700/50">
              ...
              <button
                ...
                className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 cursor-pointer active:scale-95 flex items-center gap-2 justify-center glass-button-enhanced ${
                  hasUnsavedChanges
                    ? "text-orange-400 hover:text-orange-300 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed"
                    : "text-violet-400 hover:text-violet-300 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed"
                }`}
              >
                {isLoading ? (
                  <>
