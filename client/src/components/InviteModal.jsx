      ...
      <div className="relative w-full max-w-2xl bg-white/10 dark:bg-gray-900/80 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl overflow-hidden animate-fadeIn hover:scale-[1.01] transition-transform">
        ...
        <div className="relative px-8 py-10">
          ...
          <button
            type="button"
            onClick={onClose}
            className="absolute top-5 right-5 text-gray-400 hover:text-white transition-colors text-xl cursor-pointer active:scale-95 z-10 p-2 rounded-full hover:bg-white/10 hover:rotate-90"
          >
            <X size={22} />
          </button>
            ...
            <form onSubmit={handleSendInvite} className="space-y-6">
              ...
              <div className="flex justify-end gap-3 pt-4">
                <button
                  ...
                  onClick={onClose}
                  disabled={loading}
                  className="px-6 py-3 rounded-lg bg-gray-600/20 hover:bg-gray-600/30 border border-gray-500/30 text-gray-400 hover:text-gray-300 font-semibold transition-all duration-200 cursor-pointer active:scale-95 disabled:opacity-50 shadow-lg hover:shadow-xl"
                >
                  Cancel
                </button>
                <button
