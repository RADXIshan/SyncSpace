      ...
      <nav className="bg-white/80 backdrop-blur-sm border-b border-[var(--color-gray-200)] shadow-[0_4px_6px_rgba(0,0,0,0.1)] top-0 z-50 px-8 py-4 flex flex-wrap items-center justify-between w-full">
        ...
        <div className="flex gap-4 mt-3 sm:mt-0">
          <button
            ...
            className="px-4 py-2 border border-[var(--color-gray-300)] rounded-[var(--radius-md)] font-small hover:bg-[var(--color-blue-200)] transition"
          >
            Login
          </button>
          <button
            onClick={() => (window.location.href = "/signup")}
            className="px-5 py-2 rounded-[var(--radius-md)] font-small text-white bg-[var(--color-secondary)] shadow-md hover:bg-gradient-to-r from-[var(--color-secondary)] to-[var(--color-info)]"
          >
            Sign Up
          </button>
        </div>
                ...
                <div className="flex-1 space-y-4 sm:space-y-5">
                  {[
                    ...
                    >
                      ...
                      <p className="font-medium text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed">
                        {text}
                      </p>
                    </div>
                  ))}
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="flex-1 space-y-4 sm:space-y-5">
                    {[
                      ...
                      <div
                        key={idx}
                        className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 rounded-2xl bg-white/10 backdrop-blur-sm hover:bg-white/20 transition-all duration-300 border border-white/20"
                      >
                        ...
                        <p className="font-medium text-sm sm:text-base lg:text-lg text-white leading-relaxed">
                          {text}
                        </p>
                      </div>
                    ))}
...
// ✅ Extracted FAQ logic into its own component
function FAQList() {
