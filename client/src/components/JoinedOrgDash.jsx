  ...
  return (
    <>
      ...
      <main className="grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-6 auto-rows-auto lg:auto-rows-[300px]">
        ...
        <section className="order-3 lg:order-3 col-span-1 lg:col-span-6 bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 shadow-lg hover:shadow-xl border border-white/20 flex flex-col justify-between min-h-[300px]">
